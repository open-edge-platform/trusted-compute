...
# TC8: Verify TW upgrade test case
...
verify_tw_upgrade() {
    echo "================================"
    echo "TC8: Verify TW upgrade test case"
    echo "================================"
    ...
    if ! install_tw_helm_chart $previous_version; then
        ...
        echo "RESULT:  Verify TW upgrade test case [ failed ]"
        exit 1
    fi
    ...
    echo "RESULT:  Verify TW upgrade test case [ successful ]"
    echo ""
}
