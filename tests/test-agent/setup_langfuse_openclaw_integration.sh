...
NEXTAUTH_URL=$(container_env_value langfuse-web NEXTAUTH_URL)
NEXTAUTH_SECRET=$(container_env_value langfuse-web NEXTAUTH_SECRET)
SALT=$(container_env_value langfuse-worker SALT)
ENCRYPTION_KEY=$(container_env_value langfuse-worker ENCRYPTION_KEY)
POSTGRES_PASSWORD=$(container_env_value postgres POSTGRES_PASSWORD)
DATABASE_URL=$(container_env_value langfuse-worker DATABASE_URL)
CLICKHOUSE_PASSWORD=$(container_env_value clickhouse CLICKHOUSE_PASSWORD)
MINIO_ROOT_PASSWORD=$(container_env_value minio MINIO_ROOT_PASSWORD)
LANGFUSE_S3_EVENT_UPLOAD_SECRET_ACCESS_KEY=$(container_env_value langfuse-worker LANGFUSE_S3_EVENT_UPLOAD_SECRET_ACCESS_KEY)
LANGFUSE_S3_MEDIA_UPLOAD_SECRET_ACCESS_KEY=$(container_env_value langfuse-worker LANGFUSE_S3_MEDIA_UPLOAD_SECRET_ACCESS_KEY)
LANGFUSE_S3_BATCH_EXPORT_SECRET_ACCESS_KEY=$(container_env_value langfuse-worker LANGFUSE_S3_BATCH_EXPORT_SECRET_ACCESS_KEY)
REDIS_AUTH=$(container_env_value langfuse-worker REDIS_AUTH)
